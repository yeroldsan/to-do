...
const getAllTasks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield database_1.pool.query("select * from task order by completed desc");
...
const createTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield database_1.pool.query(sql, [description, completed]);
        const rows = result.rows ? result.rows : [];
...
const updateTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield database_1.pool.query(sql, [
            description,
            completed,
            id,
        ]);
...
const deleteTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield database_1.pool.query(sql, [id]);
...
const statusTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield database_1.pool.query(sql, [completed, id]);
